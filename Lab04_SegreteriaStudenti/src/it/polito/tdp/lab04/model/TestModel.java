...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		// Punto 1
				...
				for (Studente s : model.getStudentiIscrittiAlCorso(new Corso("02AQJPG"))) {
				...
				// Punto 4
				sb = new StringBuilder();
				for (Corso corso : model.getCorsibystudente(new Studente(146101))) {
					sb.append(String.format("%-8s ", corso.getCodins()));
					sb.append(String.format("%-2s ", corso.getCrediti()));
					sb.append(String.format("%-50s ", corso.getNome()));
					sb.append(String.format("%-4s ", corso.getPd()));
				...
				// Punto 5
				boolean result = model.studenteiscrittoalcorso(146101, new Corso("01NBAPG"));
